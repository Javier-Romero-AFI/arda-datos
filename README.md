...
Cómo se generan y se firman: `scripts/zonas-mx.py`, `scripts/zonas-cdmx.py` y `scripts/firmar-zonas.py` en el
repositorio de la app. La llave privada que firma no está en ningún repositorio.

## Licencia

[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.es). Los datos fuente conservan las licencias de
sus autores (SESNSP, INEGI, FGJ CDMX, IECM: datos abiertos del gobierno de México).
